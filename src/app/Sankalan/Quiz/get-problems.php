...
function getProblems($event_id)
{
    ...
    $problems = $db->query('SELECT qid, statement, choice1, choice2, choice3, choice4, multi_sol FROM questions WHERE event_id = :event_id LIMIT 30', ['event_id' => $event_id], false);
